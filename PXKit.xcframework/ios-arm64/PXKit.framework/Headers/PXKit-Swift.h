...
@property (nonatomic, copy) NSString * _Nullable parentGroupId;
...
/// <ul>
///   <li>
///     default: first connected window scene’s key window
///   </li>
///   <li>
...
SWIFT_CLASS("_TtCC5PXKit12PXNetworking15SessionDelegate")
